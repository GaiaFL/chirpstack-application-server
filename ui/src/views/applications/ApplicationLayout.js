...
import CreateKonkerIntegration from "./integrations/CreateKonkerIntegration";
...
import UpdateKonkerIntegration from "./integrations/UpdateKonkerIntegration";
      ...
      <Grid container spacing={4}>
        ...
        <Grid item xs={12}>
          <Switch>
            ...
            <Route exact path={`${this.props.match.path}/integrations/konker/create`} render={props => <CreateKonkerIntegration {...props} />} />
            <Route exact path={`${this.props.match.path}/integrations/konker/edit`} render={props => <UpdateKonkerIntegration {...props} />} />
          </Switch>
        </Grid>
      </Grid>
    );
